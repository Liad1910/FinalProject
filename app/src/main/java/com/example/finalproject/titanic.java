...
public class titanic extends AppCompatActivity {
    ...
    private static final String TRAILER_URL = "https://www.youtube.com/watch?v=CHekzSiZjrY";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_titanic); // לוודא שהשם של ה-XML הוא titanic.xml
        ...
        // כפתור מועדפים – כאן תחברי למימוש שלך (Firestore / Realtime / Local)
        btnFavorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO: לשמור את "טיטאניק" למועדפים של המשתמש
            }
        });
    }
}
